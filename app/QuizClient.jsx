...
export default function QuizClient() {
  ...
  const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbyuKrQELcyYked9IVYKOWRakHwDLpJQmGxv-XnATXjLs-sa-hGdNRod6-O56GwTIJ0/exec";
                ...
                <section style={{ width: "90vw", maxWidth: "90vw", marginInline: "auto" }}>
                  ...
                  {(() => {
                    ...
                    if (current.type === "slider" || isActiveWeek(current)) {
                      ...
                      return (
                        <div style={{ width: "90vw", maxWidth: "60vw", marginInline: "auto" }}>
                          <div
